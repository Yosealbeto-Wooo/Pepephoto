...
const en: TranslationKeys = {
    ...
    'error.apiKey.description': 'The Gemini API key is not available. Please check the `VITE_API_KEY` environment variable in your hosting platform\'s settings. Make sure it is set correctly and redeploy.',
...
export const translations: { [key: string]: TranslationKeys } = {
  ...
  es: {
    ...
    'error.apiKey.description': 'La clave de API de Gemini no está disponible. Por favor, revisa la variable de entorno `VITE_API_KEY` en la configuración de tu plataforma de hosting. Asegúrate de que el valor sea correcto y vuelve a desplegar la aplicación.',
